            ...
            obtenerVentas(){
                ...
                .then(resultado => {
                    ...
                    this.totalesGenerales = [
                        ...
                        {nombre: "Total ventas", total: 'Bs' + resultado.totalVentas, icono: "cash-fast", clase: "has-text-success"},
                        {nombre: "Ganancia", total: 'Bs' + Utiles.calcularTotalGanancia(this.ventas), clase: "has-text-info"},
