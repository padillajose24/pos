            ...
            obtenerCuentas(){
                ...
                .then(resultado => {
                    ...
                    this.totalesGenerales = [
                        ...
                        {nombre: "Total ", total: 'Bs' + resultado.totalCuentas, icono: "cash-fast", clase: "has-text-success"},
                        ...
                        {nombre: "Ganancia", total: 'Bs' + Utiles.calcularTotalGanancia(this.cuentas), clase: "has-text-info"}
                    ]
                    this.cargando = false
                })
            }
