            ...
            <table>
                ...
                <tbody>
                    <tr v-for="(producto, index) in venta.productos" :key="index">
                        ...
                        <td>Bs{{ producto.precio}} X {{ producto.cantidad }}</td>
                        <td>Bs{{ producto.precio * producto.cantidad }}</td>
                    </tr>
                </tbody>
            </table>
            <p><b>Total:</b>Bs{{ venta.total }}</p>
            <p v-if="tipo !== 'cotiza'"><b>Su pago:</b>Bs{{ venta.pagado }}</p>
            <p v-if="tipo === 'venta'"><b>Cambio:</b>Bs{{ venta.pagado - venta.total }}</p>
            <p v-if="tipo === 'cuenta' || tipo === 'apartado'"><b>Por pagar:</b>Bs{{ venta.porPagar }}</p>
