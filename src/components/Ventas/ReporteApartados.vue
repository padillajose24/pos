		...
		methods: {
			...
			onLiquidar(apartado) {
                this.$buefy.dialog.confirm({
                    message: '¿Liquidar apartado? El cliente debe pagar: Bs' + apartado.porPagar,
                    cancelText: 'Cancelar',
            ...
            onAbonar(apartado) {
                this.$buefy.dialog.prompt({
                    message: `Escribe el total del abono. Restan: Bs` + apartado.porPagar,
                    cancelText: 'Cancelar',
                    confirmText: 'Abonar',
                    inputAttrs: {
                        type: 'number',
			...
			obtenerApartados(){
				...
				.then(resultado => {
					...
					this.totalesGenerales = [
                        ...
                        {nombre: "Total ", total: 'Bs' + resultado.totalApartados, icono: "cash-fast", clase: "has-text-success"},
                        {nombre: "Por pagar", total: 'Bs' + resultado.totalPorPagar, icono: "alert", clase: "has-text-danger"},
                        {nombre: "Pagos", total: 'Bs' + resultado.totalPagos, icono: "account-cash", clase: "has-text-grey-light"},
                        {nombre: "# Productos", total: Utiles.calcularProductosVendidos(this.apartados), icono: "package-variant", clase: "has-text-warning"},
                        {nombre: "Ganancia", total: 'Bs' + Utiles.calcularTotalGanancia(this.apartados), clase: "has-text-info"}
                    ]
					this.cargando = false
				})
			}
