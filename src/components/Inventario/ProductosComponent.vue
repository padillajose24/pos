              ...
              <b-table-column field="codigo" label="Código" sortable searchable v-slot="props">
                ...
                <b-table-column field="vendidoMayoreo" label="¿Mayoreo?" sortable v-slot="props">
                    ...
                    <div v-if="props.row.vendidoMayoreo">
                        <b>Precio: </b>Bs{{ props.row.precioMayoreo}}<br>
            ...
            obtenerProductos(){
                ...
                .then(respuesta => {
                    ...
                    this.cartasTotales = [
                        ...
                        {nombre: "Total inventario", total: 'Bs' + respuesta.totalInventario, clase: "has-text-success"},
                        {nombre: "Ganancia", total: 'Bs' + respuesta.gananciaInventario, clase: "has-text-info"},
                    ]
                    this.cargando = false
                })
            }
