...
function registrarAjustes($ajustes){
	...
	"INSERT INTO configuracion (nombre, telefono, logo, dolar ) VALUES (?,?,?,?)" :
	"UPDATE configuracion SET nombre = ?, telefono = ?, logo = ?,dolar = ?";

	$parametros = [$ajustes->nombre, $ajustes->telefono, $logo, $ajustes->dolar];
